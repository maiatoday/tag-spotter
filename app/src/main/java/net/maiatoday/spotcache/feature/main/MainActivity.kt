...
import net.maiatoday.spotcache.core.ui.theme.MyApplicationTheme
import net.maiatoday.spotcache.core.database.ImportPackWorker
import java.io.File
...
class MainActivity : ComponentActivity() {
  ...
  private fun handleImportIntent(intent: Intent?) {
    ...
    if (isFileScheme && fileName != null && 
      ...
      Toast.makeText(this, "Not a valid SpotCache Pack (.ts_pack)", Toast.LENGTH_LONG).show()
      return
    }
