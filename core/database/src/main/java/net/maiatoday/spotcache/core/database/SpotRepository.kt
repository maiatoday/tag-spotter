...
class LocalSpotRepository(
    ...
    override suspend fun loadTestData() {
        ...
        val image1 = SpotImage(
            id = 9001L,
            spotId = 9001L,
            imagePath = "android.resource://net.maiatoday.spotcache/drawable/ic_launcher_foreground",
            thumbnailPath = "android.resource://net.maiatoday.spotcache/drawable/ic_launcher_foreground",
