...
object KmlExporter {
    fun generateKml(spots: List<SpotDetails>): String {
        ...
        sb.append("  <Document>\n")
        sb.append("    <name>TagSpotter Export</name>\n")
        sb.append("    <description>Exported spots from TagSpotter app</description>\n")
        ...
        for (spotDetails in spots) {
            ...
            detailsSb.append("Logged Date: ${DateFormatter.formatDate(spot.createdAt, "MMMM dd, yyyy - hh:mm a")}\n")
